...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:Administrador'])->group(function () {
        ...
        Route::get('/Admin/Muestras', [MuestraController::class, 'index'])->name('muestras.index');
        Route::get('/Admin/Muestras/create', [MuestraController::class, 'create'])->name('muestras.create');
        Route::post('/Admin/Muestras', [MuestraController::class, 'store'])->name('muestras.store');
        Route::get('/Admin/Muestras/{muestra}/edit', [MuestraController::class, 'edit'])->name('muestras.edit');
        Route::put('/Admin/Muestras/{muestra}', [MuestraController::class, 'update'])->name('muestras.update');
        Route::delete('/Admin/Muestras/{muestra}', [MuestraController::class, 'destroy'])->name('muestras.destroy');
        Route::patch('/Admin/Muestras/{id}/update-visibility', [MuestraController::class, 'updateVisibility'])->name('muestras.updateVisibility');
