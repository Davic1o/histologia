...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:Administrador'])->group(function () {
        ...
        Route::get('/muestras/create', [MuestraController::class, 'create'])->name('muestras.create');
        Route::post('/muestras', [MuestraController::class, 'store'])->name('muestras.store');
        Route::get('/muestras/{muestra}/edit', [MuestraController::class, 'edit'])->name('muestras.edit');
        Route::put('/muestras/{muestra}', [MuestraController::class, 'update'])->name('muestras.update');
        Route::delete('/muestras/{muestra}', [MuestraController::class, 'destroy'])->name('muestras.destroy');
