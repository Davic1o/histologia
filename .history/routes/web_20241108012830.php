...
Route::middleware(['auth'])->group(function () {
    Route::middleware(['role:Doctor'])->group(function () {
        ...
        Route::post('/Doctor/Anotacion', [DoctorController::class, 'anotacion'])->name('doctor.anotacion');
        Route::put('/Doctor/update/{id}', [MuestraController::class, 'update'])->name('doctor.update');
    });
