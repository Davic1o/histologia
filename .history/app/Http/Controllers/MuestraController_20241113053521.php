    ...
    public function updateVisibility(Request $request, $id)
{
    // Validar los datos de entrada
    $validated = $request->validate([
        'visibilidad' => 'required|boolean', // Asegura que el valor de visibilidad sea booleano
    ]);
    ...
    return redirect()->route('muestras.index')->with('success', 'Visibilidad actualizada exitosamente.');
}
