...
<div className="p-32 bg-gray-100 shadow-md rounded-lg">
            <div className="flex justify-between items-center mb-4">
                ...
                <Link href="/type-tissues/create" className="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md shadow">
