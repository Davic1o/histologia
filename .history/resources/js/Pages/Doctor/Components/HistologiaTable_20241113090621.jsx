...
import OpenSeadragonEditer from './OpenSeadragonEditer';
...
const HistologiaTable = ({ muestras, TypeTissues, user }) => {
    ...
    return (
        <div className="overflow-x-auto">
                        ...
                        muestras.map(muestra => (
                            <tr key={muestra.id} className="border-b hover:bg-gray-50">
                                ...
                                <div onClick={() => openModal(muestra.id)}>
                                    ...
                                    {muestra.visibilidad === 1 && (
                                        <>
                                        <div onClick={() => openModal2(muestra)}>
            ...
            {isEditing && (
             <Modal isOpen2={isModalOpen2} onClose={closeModal}>
             <OpenSeadragonViewer imagenDzi="312426.dzi" muestraId={selectedSampleId} />
            </Modal>
            )}
             <Modal isOpen={isModalOpen} onClose={closeModal}>
             <OpenSeadragonEditer imagenDzi="312426.dzi" muestraId={selectedSampleId} />
            </Modal>
        </div>
    );
};
