...
const OpenSeadragonWithAnnotations = ({ imageUrl }) => {
    ...
    useEffect(() => {
        // Asegúrate de que viewerRef.current esté disponible
        ...
        return () => {
            // Limpieza del visor al desmontar el componente
            if (viewerInstance) {
    ...
    return (
        <div>
            ...
            {/* Asegúrate de que el contenedor tenga un ID único */}
            <div ref={viewerRef} id="openseadragon" style={{ width: '800px', height: '600px', margin: '20px auto', border: '1px solid #ccc' }}></div>
