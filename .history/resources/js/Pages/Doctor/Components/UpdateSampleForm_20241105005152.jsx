...
const UpdateSampleForm = ({ onClose, TypeTissues, sample }) => {
    const { data, setData, put, errors } = useForm({
        ...
        tissues_id: sample.type_tissue_id || '', // Asegúrate de que este campo se corresponda correctamente
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('doctor.update', sample.id), { // Asegúrate de pasar el ID de la muestra aquí
            onSuccess: () => onClose(),
        });
    };
