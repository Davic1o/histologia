  ...
  const toggleAnnotationMode = () => {
    setAnnotationMode((prevState) => {
      ...
      if (anno) {
        ...
        anno.setDrawingEnabled(newState);  // Activar o desactivar el modo de dibujo
      }
      if (viewer) {
        // Bloquear o habilitar la interacción con la imagen
        viewer.setMouseNavEnabled(!newState); // Deshabilita el control del ratón en el modo de anotación
        viewer.innerTracker.setTracking(!newState); // Deshabilita el seguimiento del ratón
      }
      return newState;
    });
  };
